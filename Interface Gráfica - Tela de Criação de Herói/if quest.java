 ...
 * instruções da atividade, a criação da interface gráfica em Java Swing,
 * o uso de JFrame, JLabel, JTextField, JButton, JPanel e dos gerenciadores
 * de layout BorderLayout, GridLayout e FlowLayout.
 *
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TelaCriacaoHeroiFlow tela = new TelaCriacaoHeroiFlow();
...
class TelaCriacaoHeroiFlow extends JFrame {

    public TelaCriacaoHeroiFlow() {
        super("IF Quest - FlowLayout");
        setSize(400, 300);
        setDefaultCloseOperation(EXIT_ON_CLOSE);
...
class Guerreiro extends Personagem {
    ...
    public void golpeEspecial()
        ...
        System.out.println("O Guerreiro realizou um golpe especial!");
    }
